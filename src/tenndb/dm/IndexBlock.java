...
public class IndexBlock {
	...
	public static void toByteBuffer(IndexBlock blk, ByteBuffer buff){
		if(null != blk){
	...
	public IndexBlock copyData(){
		IndexBlock blk = new IndexBlock(this.key);
